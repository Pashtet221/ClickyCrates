...
public class CharacterShopUI : MonoBehaviour
{
	...
	void OnItemPurchased (int index)
	{
		...
		if (GameDataManager.CanSpendCoins (character.price)) {
            ...
            {
                case 5:
                    GameManager.instance.BuyPrefab(1);
                    break;
                case 6:
                    GameManager.instance.BuyPrefab(3);
                    break;
                case 7:
                    GameManager.instance.BuyPrefab(5);
                    break;
                case 8:
                    GameManager.instance.BuyPrefab(0);
                    break;
                case 9:
                    GameManager.instance.BuyPrefab(4);
                    break;
                case 10:
                    GameManager.instance.BuyPrefab(2);
                    break;
            }
